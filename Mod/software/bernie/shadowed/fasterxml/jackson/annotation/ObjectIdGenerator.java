...
/* 180 */       return String.format("[ObjectId: key=%s, type=%s, scope=%s]", new Object[] { this.key, (this.type == null) ? "NONE" : this.type.getName(), (this.scope == null) ? "NONE" : this.scope.getName() });
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\Logan\Downloads\SchnurriTV's Sexmod-1.8.0.jar!\software\bernie\shadowed\fasterxml\jackson\annotation\ObjectIdGenerator.class
