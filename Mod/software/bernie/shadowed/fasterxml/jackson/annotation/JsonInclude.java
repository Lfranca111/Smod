...
/* 264 */       this(src.value(), src.content(), src.valueFilter(), src.contentFilter());
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 293 */       return (base == null) ? overrides : base.withOverrides(overrides);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 495 */       sb.append("JsonInclude.Value(value=").append(this._valueInclusion).append(",content=").append(this._contentInclusion);
/*     */ 
/*     */ 
/*     */       
...
/*     */     
/*     */     public int hashCode() {
/* 510 */       return (this._valueInclusion.hashCode() << 2) + this._contentInclusion.hashCode();
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* Location:              C:\Users\Logan\Downloads\SchnurriTV's Sexmod-1.9.0.jar!\software\bernie\shadowed\fasterxml\jackson\annotation\JsonInclude.class
