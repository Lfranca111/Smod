...
public class b0<T extends bS & IAnimatable> extends GeoEntityRenderer<T> {
  static final float e = 1.5F;
  
  public static final float p = 0.1F;
  
  public static final Vec3d v = new Vec3d(0.95D, 0.65D, 0.85D);
  
  public static final Vec3d a = new Vec3d(0.0D, 0.2D, 0.3D);
  ...
  protected static HashMap<bB, HashMap<String, Boolean>> l = new HashMap<>();
  
  protected static HashMap<UUID, ResourceLocation> q = new HashMap<>();
  
  Color c = new Color(245, 199, 165);
  
  Color i = new Color(245, 157, 169);
  ...
  public static BufferBuilder s;
  
  Matrix4f u = null;
  
  protected GeoBone t = null;
  
  public b0(RenderManager paramRenderManager, AnimatedGeoModel<T> paramAnimatedGeoModel, double paramDouble) {
  ...
  protected ResourceLocation a(T paramT) throws IOException {
    ...
    try {
      if (((bS)paramT).field_70170_p instanceof com.c || paramT.n() == null) {
        resourceLocation = q.get(this.g.func_110432_I().func_148256_e().getId());
        try {
          if (resourceLocation == null)
            return a(this.g.func_110432_I().func_148256_e().getId(), ((bS)paramT).field_70170_p); 
        } catch (IOException iOException) {
          throw a(null);
        } 
      } else {
        resourceLocation = q.get(paramT.n());
        try {
          if (resourceLocation == null)
            return a(paramT.n(), ((bS)paramT).field_70170_p); 
        } catch (IOException iOException) {
          throw a(null);
        } 
      } 
  ...
  protected ResourceLocation a(UUID paramUUID, World paramWorld) throws IOException {
    ...
    try {
      ...
      bufferedImage = ImageIO.read(this.g.func_110442_L().func_110536_a(new ResourceLocation("sexmod", "textures/player/steve.png")).func_110527_b());
    } 
    q.put(paramUUID, this.field_76990_c.field_78724_e.func_110578_a("player" + paramUUID, new DynamicTexture(bufferedImage)));
    return q.get(paramUUID);
  }
  ...
  float a(World paramWorld, Vec3d paramVec3d, float paramFloat1, float paramFloat2) {
    RayTraceResult rayTraceResult = a(paramVec3d, paramVec3d.func_178787_e(aH.a(new Vec3d(0.0D, 0.0D, -4.0D), paramFloat1, paramFloat2)), paramWorld);
    try {
  ...
  boolean a(T paramT, EntityPlayer paramEntityPlayer) {
    try {
      if (paramT instanceof bo)
        return true; 
    } catch (IllegalStateException illegalStateException) {
      throw a(null);
    } 
    World world = ((bS)paramT).field_70170_p;
    Vec3d vec3d1 = paramT.func_174791_d();
    float f1 = ((bS)paramT).field_70130_N * 1.5F;
    float f2 = ((bS)paramT).field_70131_O * 1.5F;
    Vec3d vec3d2 = paramEntityPlayer.func_174791_d().func_72441_c(0.0D, paramEntityPlayer.func_70047_e(), 0.0D);
    int i = this.g.field_71474_y.field_74320_O;
    try {
      if (i != 0)
        return true; 
    } catch (IllegalStateException illegalStateException) {
  ...
  HashSet<String> a(Boolean paramBoolean, boolean paramBoolean1) {
  ...
  public void a(GeoModel paramGeoModel, T paramT, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5) {
    try {
      if (this.g.field_71439_g != null)
        try {
          if (!((bS)paramT).l)
            try {
              if (!a(paramT, (EntityPlayer)this.g.field_71439_g))
                return; 
            } catch (IOException iOException) {
              throw a(null);
            }  
    ...
    this.d = a(Boolean.valueOf(((bS)paramT).l), (paramT.L() == 0));
    f();
    bB bB = bB.a((Entity)paramT);
    try {
      if (l.get(bB) == null)
        a(paramT.K().getModelRendererList(), d(), bB); 
    } catch (IOException iOException) {
      throw a(null);
    } 
    this.b = aH.a((EntityLivingBase)paramT, paramFloat1);
    ...
    try {
      ...
      if (geoBone != null) {
        bufferBuilder.func_181668_a(7, DefaultVertexFormats.field_181712_l);
        try {
          (Minecraft.func_71410_x()).field_71446_o.func_110577_a(a(this.n));
        } catch (IOException iOException) {
  ...
  public void a(T paramT, double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat1, float paramFloat2) {
    ...
    //   5: aload_0
    //   6: getfield n : Lcom/schnurritv/sexmod/bS;
    //   9: getfield field_70170_p : Lnet/minecraft/world/World;
    //   12: instanceof com/c
    //   15: ifne -> 577
    //   18: aload_0
    //   19: getfield n : Lcom/schnurritv/sexmod/bS;
    //   22: invokevirtual T : ()Z
    //   25: ifeq -> 88
    //   28: goto -> 35
    //   31: invokestatic a : (Ljava/lang/Exception;)Ljava/lang/Exception;
    //   34: athrow
    //   35: aload_0
    //   36: getfield n : Lcom/schnurritv/sexmod/bS;
    //   39: instanceof com/schnurritv/sexmod/bo
    //   42: ifeq -> 72
    //   45: goto -> 52
    //   48: invokestatic a : (Ljava/lang/Exception;)Ljava/lang/Exception;
    //   51: athrow
    //   52: aload_0
    //   53: getfield g : Lnet/minecraft/client/Minecraft;
    ...
    //   95: istore #11
    //   97: aload #10
    //   99: getstatic com/schnurritv/sexmod/bS.b : Lnet/minecraft/network/datasync/DataParameter;
    ...
    //   113: ifne -> 362
    //   116: aload_0
    //   117: getfield n : Lcom/schnurritv/sexmod/bS;
    //   120: getfield field_70170_p : Lnet/minecraft/world/World;
    //   123: aload #10
    //   125: getstatic com/schnurritv/sexmod/bS.b : Lnet/minecraft/network/datasync/DataParameter;
    ...
    //   209: astore #13
    //   211: aload_0
    //   212: getfield g : Lnet/minecraft/client/Minecraft;
    ...
    //   364: ifne -> 577
    //   367: aload #10
    //   369: getstatic com/schnurritv/sexmod/bS.z : Lnet/minecraft/network/datasync/DataParameter;
    ...
    //   390: athrow
    //   391: aload_1
    //   392: instanceof com/schnurritv/sexmod/bo
    //   395: ifeq -> 442
    //   398: goto -> 405
    //   401: invokestatic a : (Ljava/lang/Exception;)Ljava/lang/Exception;
    //   404: athrow
    //   405: aload_1
    //   406: checkcast com/schnurritv/sexmod/bo
    //   409: invokevirtual c : ()Z
    //   412: ifeq -> 442
    //   415: goto -> 422
    //   418: invokestatic a : (Ljava/lang/Exception;)Ljava/lang/Exception;
    //   421: athrow
    //   422: aload_0
    //   423: getfield g : Lnet/minecraft/client/Minecraft;
    ...
    //   479: aload_0
    //   480: getfield g : Lnet/minecraft/client/Minecraft;
    ...
    //   495: astore #12
    //   497: aload_0
    //   498: getfield n : Lcom/schnurritv/sexmod/bS;
    //   501: invokevirtual I : ()Lnet/minecraft/util/math/Vec3d;
    //   504: aload #12
    ...
    //   529: dstore #6
    //   531: aload #10
    //   533: getstatic com/schnurritv/sexmod/bS.e : Lnet/minecraft/network/datasync/DataParameter;
    ...
    //   594: dload #6
    //   596: fload #9
    //   598: invokevirtual a : (Lcom/schnurritv/sexmod/bS;DDDF)V
    //   601: goto -> 608
    ...
    //   894: fload #12
    //   896: fload #9
    //   898: invokevirtual a : (Lcom/schnurritv/sexmod/bS;FFF)V
    //   901: fconst_0
    //   902: fstore #17
    //   904: fconst_0
    //   905: fstore #18
    ...
    //   1188: ldc 255.0
    //   1190: fdiv
    //   1191: invokevirtual a : (Lsoftware/bernie/geckolib3/geo/render/built/GeoModel;Lcom/schnurritv/sexmod/bS;FFFFF)V
    //   1194: iload #24
    //   1196: ifeq -> 1209
    ...
    //   1283: aload_1
    //   1284: fload #9
    //   1286: invokestatic a : (Lcom/schnurritv/sexmod/bS;F)V
    //   1289: return
    // Exception table:
    //   from	to	target	type
  ...
  protected void a(T paramT, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    EntityPlayer entityPlayer = ((bS)paramT).field_70170_p.func_152378_a(uUID);
    try {
  ...
  protected void a(bS parambS, double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat) {
    Entity entity = parambS.func_110166_bE();
    paramDouble2 -= (1.6D - parambS.field_70131_O) * 0.5D;
    Tessellator tessellator = Tessellator.func_178181_a();
    BufferBuilder bufferBuilder = tessellator.func_178180_c();
    double d1 = aH.a(entity.field_70126_B, entity.field_70177_z, paramFloat * 0.5F) * 0.01745329238474369D;
    double d2 = aH.a(entity.field_70127_C, entity.field_70125_A, paramFloat * 0.5F) * 0.01745329238474369D;
    ...
    double d7 = aH.b(entity.field_70169_q, entity.field_70165_t, paramFloat) - d3 * 0.7D - d4 * 0.5D * d6;
    double d8 = aH.b(entity.field_70167_r + entity.func_70047_e() * 0.7D, entity.field_70163_u + entity.func_70047_e() * 0.7D, paramFloat) - d5 * 0.5D - 0.25D;
    double d9 = aH.b(entity.field_70166_s, entity.field_70161_v, paramFloat) - d4 * 0.7D + d3 * 0.5D * d6;
    double d10 = aH.a(parambS.field_70760_ar, parambS.field_70761_aq, paramFloat) * 0.01745329238474369D + 1.5707963267948966D;
    d3 = Math.cos(d10) * parambS.field_70130_N * 0.4D;
    d4 = Math.sin(d10) * parambS.field_70130_N * 0.4D;
    double d11 = aH.b(parambS.field_70169_q, parambS.field_70165_t, paramFloat) + d3;
    double d12 = aH.b(parambS.field_70167_r, parambS.field_70163_u, paramFloat);
    double d13 = aH.b(parambS.field_70166_s, parambS.field_70161_v, paramFloat) + d4;
    paramDouble1 += d3;
    paramDouble3 += d4;
  ...
  public void renderRecursively(BufferBuilder paramBufferBuilder, GeoBone paramGeoBone, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4) {
    try {
      if (((bS)this.n).field_70170_p instanceof com.c)
        return; 
    } catch (IllegalStateException illegalStateException) {
      throw a(null);
    } 
  ...
  protected Vector4f a(float paramFloat1, float paramFloat2, float paramFloat3) {
  ...
  protected Vector4f a(String paramString, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    try {
      if (((Integer)((bS)this.n).p.func_187225_a(bS.F)).intValue() == 0)
        return a(paramFloat1, paramFloat2, paramFloat3); 
    } catch (IllegalStateException illegalStateException) {
      throw a(null);
    } 
    ...
    try {
      if (!(geoModelProvider instanceof bE))
        return a(paramFloat1, paramFloat2, paramFloat3); 
    } catch (IllegalStateException illegalStateException) {
      throw a(null);
    } 
    bE bE = (bE)geoModelProvider;
    ItemStack itemStack = bE.a((bS)this.n, paramString);
    try {
  ...
  public void a(T paramT, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5) {
    this.u = (Matrix4f)MATRIX_STACK.getModelMatrix().clone();
  }
  ...
  protected boolean c() {
    ...
    return (this.g.field_71474_y.field_74320_O != 0);
  }
  ...
  public void a(BufferBuilder paramBufferBuilder, GeoCube paramGeoCube, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, double paramDouble) {
    // Byte code:
    //   0: getstatic com/schnurritv/sexmod/b0.MATRIX_STACK : Lsoftware/bernie/geckolib3/util/MatrixStack;
    //   3: aload_2
    //   4: invokevirtual moveToPivot : (Lsoftware/bernie/geckolib3/geo/render/built/GeoCube;)V
    //   7: getstatic com/schnurritv/sexmod/b0.MATRIX_STACK : Lsoftware/bernie/geckolib3/util/MatrixStack;
    //   10: aload_2
    //   11: invokevirtual rotate : (Lsoftware/bernie/geckolib3/geo/render/built/GeoCube;)V
    //   14: getstatic com/schnurritv/sexmod/b0.MATRIX_STACK : Lsoftware/bernie/geckolib3/util/MatrixStack;
    //   17: aload_2
    ...
    //   95: astore #13
    //   97: getstatic com/schnurritv/sexmod/b0.MATRIX_STACK : Lsoftware/bernie/geckolib3/util/MatrixStack;
    ...
    //   324: astore #14
    //   326: aload_0
    //   327: invokevirtual a : ()Z
    //   330: ifeq -> 348
    //   333: aload_0
    //   334: aload #14
    //   336: aload #13
    //   338: invokevirtual a : (Lnet/minecraft/util/math/Vec3d;Ljavax/vecmath/Vector3f;)Lnet/minecraft/util/math/Vec3d;
    //   341: goto -> 350
    ...
    //   350: astore #15
    //   352: aload #12
    //   354: getfield vertices : [Lsoftware/bernie/geckolib3/geo/render/built/GeoVertex;
    //   357: astore #16
    //   359: aload #16
    //   361: arraylength
    //   362: istore #17
    ...
    //   378: aaload
    //   379: astore #19
    //   381: new javax/vecmath/Vector4f
    //   384: dup
    //   385: aload #19
    //   387: getfield position : Ljavax/vecmath/Vector3f;
    //   390: invokevirtual getX : ()F
    //   393: aload #19
    //   395: getfield position : Ljavax/vecmath/Vector3f;
    //   398: invokevirtual getY : ()F
    //   401: aload #19
    //   403: getfield position : Ljavax/vecmath/Vector3f;
    //   406: invokevirtual getZ : ()F
    //   409: fconst_1
    //   410: invokespecial <init> : (FFFF)V
    //   413: astore #20
    //   415: getstatic com/schnurritv/sexmod/b0.MATRIX_STACK : Lsoftware/bernie/geckolib3/util/MatrixStack;
    //   418: invokevirtual getModelMatrix : ()Ljavax/vecmath/Matrix4f;
    //   421: aload #20
    //   423: invokevirtual transform : (Ljavax/vecmath/Tuple4f;)V
    //   426: aload_1
    //   427: aload #20
    //   429: invokevirtual getX : ()F
    //   432: f2d
    //   433: aload #20
    //   435: invokevirtual getY : ()F
    //   438: f2d
    //   439: aload #20
    //   441: invokevirtual getZ : ()F
    //   444: f2d
    //   445: invokevirtual func_181662_b : (DDD)Lnet/minecraft/client/renderer/BufferBuilder;
    //   448: aload #19
    //   450: getfield textureU : F
    //   453: f2d
    //   454: dload #7
    //   456: dadd
    //   457: aload #19
    //   459: getfield textureV : F
    //   462: f2d
    //   463: invokevirtual func_187315_a : (DD)Lnet/minecraft/client/renderer/BufferBuilder;
    //   466: aload #15
    //   468: getfield field_72450_a : D
    //   471: d2f
    //   472: aload #15
    //   474: getfield field_72448_b : D
    //   477: d2f
    //   478: aload #15
    //   480: getfield field_72449_c : D
    //   483: d2f
    //   484: fload #6
    //   486: invokevirtual func_181666_a : (FFFF)Lnet/minecraft/client/renderer/BufferBuilder;
    //   489: aload #13
    //   491: invokevirtual getX : ()F
    //   494: aload #13
    //   496: invokevirtual getY : ()F
    //   499: aload #13
    //   501: invokevirtual getZ : ()F
    //   504: invokevirtual func_181663_c : (FFF)Lnet/minecraft/client/renderer/BufferBuilder;
    //   507: invokevirtual func_181675_d : ()V
    //   510: iinc #18, 1
    //   513: goto -> 367
    //   516: iinc #11, 1
    //   519: goto -> 35
    ...
    //   326	344	344	java/lang/IllegalStateException
  }
  ...
  protected boolean a() {
    bB bB = bB.a((Entity)this.n);
    HashMap<Object, Object> hashMap = (HashMap)l.get(bB);
    if (hashMap == null) {
      hashMap = new HashMap<>();
      boolean bool1 = a(d());
      hashMap.put(this.t.getName(), Boolean.valueOf(bool1));
      l.put(bB, hashMap);
      return bool1;
    } 
    Boolean bool = (Boolean)hashMap.get(this.t.getName());
    if (bool == null) {
      bool = Boolean.valueOf(a(d()));
      hashMap.put(this.t.getName(), bool);
      l.put(bB, hashMap);
  ...
  boolean a(HashSet<String> paramHashSet) {
    return a(paramHashSet, this.t);
  }
  
  boolean a(HashSet<String> paramHashSet, GeoBone paramGeoBone) {
  ...
  protected void a(List<IBone> paramList, HashSet<String> paramHashSet, bB parambB) {
    HashMap<Object, Object> hashMap = new HashMap<>();
    for (IBone iBone : paramList)
      hashMap.put(iBone.getName(), Boolean.valueOf(a(paramHashSet, (GeoBone)iBone))); 
    l.put(parambB, hashMap);
  }
  
  public Vec3d a(Vec3d paramVec3d, Vector3f paramVector3f) {
    double d1 = aH.a(paramVector3f, this.b);
    double d2 = aH.a(Math.abs(d1));
    ...
    return aH.a(paramVec3d, (d1 > 0.0D) ? v : a, d2);
  }
  
  protected ItemStack e() {
    String str = (String)((bS)this.n).p.func_187225_a(bS.u);
    byte b = -1;
    try {
      switch (str.hashCode()) {
        case 95761198:
    ...
    while (true) {
      try {
        if (b < itemStack.func_190916_E()) {
          ...
          GlStateManager.func_179152_a(((bS)this.n).E, ((bS)this.n).E, ((bS)this.n).E);
          itemRenderer.func_178099_a((EntityLivingBase)this.n, new ItemStack(itemStack.func_77973_b(), 1), ItemCameraTransforms.TransformType.THIRD_PERSON_RIGHT_HAND);
          func_110776_a(Objects.<ResourceLocation>requireNonNull(getEntityTexture((EntityLivingBase)this.n)));
  ...
  protected void a(BufferBuilder paramBufferBuilder, GeoBone paramGeoBone) {
    // Byte code:
    //   0: aload_0
    //   1: getfield n : Lcom/schnurritv/sexmod/bS;
    //   4: ifnonnull -> 12
    //   7: return
    //   8: invokestatic a : (Ljava/lang/Exception;)Ljava/lang/Exception;
    //   11: athrow
    //   12: aload_0
    //   13: getfield n : Lcom/schnurritv/sexmod/bS;
    //   16: instanceof com/schnurritv/sexmod/bA
    //   19: ifne -> 27
    //   22: return
    //   23: invokestatic a : (Ljava/lang/Exception;)Ljava/lang/Exception;
    //   26: athrow
    //   27: aload_0
    //   28: getfield n : Lcom/schnurritv/sexmod/bS;
    //   31: invokevirtual func_184212_Q : ()Lnet/minecraft/network/datasync/EntityDataManager;
    //   34: astore_3
    //   35: aload_0
    //   36: getfield n : Lcom/schnurritv/sexmod/bS;
    //   39: checkcast com/schnurritv/sexmod/bA
    //   42: astore #4
    //   44: aload_3
    //   45: getstatic com/schnurritv/sexmod/bA.Q : Lnet/minecraft/network/datasync/DataParameter;
    ...
    //   57: istore #5
    //   59: aload #4
    //   61: invokevirtual o : ()Lcom/schnurritv/sexmod/m;
    //   64: getstatic com/schnurritv/sexmod/m.BOW : Lcom/schnurritv/sexmod/m;
    //   67: if_acmpeq -> 82
    //   70: aload_0
    //   71: fconst_0
    //   72: putfield h : F
    ...
    //   88: if_icmpne -> 106
    //   91: aload_3
    //   92: getstatic com/schnurritv/sexmod/bA.P : Lnet/minecraft/network/datasync/DataParameter;
    ...
    //   109: if_icmpne -> 124
    //   112: aload_3
    //   113: getstatic com/schnurritv/sexmod/bA.N : Lnet/minecraft/network/datasync/DataParameter;
    ...
    //   153: ifeq -> 222
    //   156: aload #4
    //   158: invokevirtual o : ()Lcom/schnurritv/sexmod/m;
    //   161: getstatic com/schnurritv/sexmod/m.BOW : Lcom/schnurritv/sexmod/m;
    //   164: if_acmpne -> 222
    //   167: goto -> 174
    ...
    //   231: getstatic com/schnurritv/sexmod/b0.MATRIX_STACK : Lsoftware/bernie/geckolib3/util/MatrixStack;
    //   234: aload_2
    ...
    //   273: athrow
    //   274: aload #4
    //   276: invokevirtual o : ()Lcom/schnurritv/sexmod/m;
    //   279: getstatic com/schnurritv/sexmod/m.ATTACK : Lcom/schnurritv/sexmod/m;
    //   282: if_acmpne -> 346
    //   285: aload #4
    //   287: getfield T : I
    //   290: ifne -> 346
    ...
    //   299: athrow
    //   300: aload #4
    //   302: getfield G : Lnet/minecraft/util/math/Vec3d;
    //   305: getfield field_72450_a : D
    //   308: aload #4
    //   310: getfield G : Lnet/minecraft/util/math/Vec3d;
    //   313: getfield field_72448_b : D
    //   316: aload #4
    //   318: getfield G : Lnet/minecraft/util/math/Vec3d;
    ...
    //   364: aload_0
    //   365: getfield n : Lcom/schnurritv/sexmod/bS;
    //   368: aload #6
    ...
    //   377: aload_0
    //   378: aload_0
    //   379: getfield n : Lcom/schnurritv/sexmod/bS;
...
/* Location:              C:\Users\Logan\Downloads\SchnurriTV's Sexmod-1.9.0.jar!\com\schnurritv\sexmod\b0.class
