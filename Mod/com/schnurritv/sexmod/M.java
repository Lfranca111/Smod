...
public enum m {
  ...
  public m followUp = null;
  
  public boolean useBoyCam;
  
  public boolean hideNameTag;
  
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2) {
    this.transitionTick = paramInt1;
    this.hasPlayer = paramBoolean1;
    this.autoBlink = paramBoolean2;
  ...
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3) {
    this.useBoyCam = paramBoolean3;
  }
  
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4) {
    this.useBoyCam = paramBoolean3;
    this.hideNameTag = paramBoolean4;
  }
  
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, float paramFloat1, float paramFloat2, boolean paramBoolean3) {
    this.transitionTick = paramInt1;
    this.hasPlayer = paramBoolean1;
    this.autoBlink = paramBoolean2;
    this.maxGirlPitch = paramFloat1;
    this.minGirlPitch = paramFloat2;
    this.flipGirlYaw = paramBoolean3;
    this.useBoyCam = false;
    this.hideNameTag = false;
  }
  
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, float paramFloat1, float paramFloat2, boolean paramBoolean3, boolean paramBoolean4) {
    this.transitionTick = paramInt1;
    this.hasPlayer = paramBoolean1;
    this.autoBlink = paramBoolean2;
    this.maxGirlPitch = paramFloat1;
  ...
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, float paramFloat1, float paramFloat2, boolean paramBoolean4) {
    this.transitionTick = paramInt1;
    this.hasPlayer = paramBoolean1;
    this.autoBlink = paramBoolean2;
    this.maxGirlPitch = paramFloat1;
    this.minGirlPitch = paramFloat2;
    this.flipGirlYaw = paramBoolean4;
    this.hideNameTag = false;
    this.useBoyCam = paramBoolean3;
  }
  
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, m paramm) {
    this.length = paramInt2;
    this.followUp = paramm;
  }
  
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt2, m paramm) {
    this.length = paramInt2;
    this.followUp = paramm;
    this.useBoyCam = paramBoolean3;
  }
  
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt2, m paramm, float paramFloat1, float paramFloat2, boolean paramBoolean4) {
    this.transitionTick = paramInt1;
    this.hasPlayer = paramBoolean1;
    this.autoBlink = paramBoolean2;
    this.length = paramInt2;
    this.followUp = paramm;
    this.useBoyCam = paramBoolean3;
    this.minGirlPitch = paramFloat1;
    this.maxGirlPitch = paramFloat2;
    this.flipGirlYaw = paramBoolean4;
  }
  
  m(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, int paramInt2, m paramm) {
    this.length = paramInt2;
    this.followUp = paramm;
    this.useBoyCam = paramBoolean4;
    this.hideNameTag = paramBoolean3;
  }
}


/* Location:              C:\Users\Logan\Downloads\SchnurriTV's Sexmod-1.9.0.jar!\com\schnurritv\sexmod\m.class
